...
class ShardCommand extends BaseSubCommand
{
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        if (isset($args["name"])) {
            ...
            if ($player !== null) {
                ...
                $Pbalance = $PSession->getShards();
                $sender->sendMessage(C::colorize("&r&l&6Ethereal &fHub &8» &r&f{$player->getName()}'s Shards: " . number_format($Pbalance) . "⛁"));
                if ($Pbalance < $balance) {
                    ...
                    $sender->sendMessage(C::colorize("&r&7&oYour shards are equal!"));
                }
            } else {
                $sender->sendMessage(C::colorize("&r&l&cError: Player not found."));
            }
        } else {
            $sender->sendMessage(C::colorize("&r&l&6Ethereal &fHub &8» &r&fYour Shards: " . number_format($balance) . "⛁"));
        }
    }
