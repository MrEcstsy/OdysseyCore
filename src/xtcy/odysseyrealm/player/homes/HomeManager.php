...
namespace xtcy\odysseyrealm\player\homes;
...
final class HomeManager
{
    ...
    /** @var Home[] */
    private array $homes = []; // array to fetch home data (and yes, this is storing the whole DB in to the array, but it doesn't matter.)
